...
export function TopNav({ onToggleSidebar }: { onToggleSidebar: () => void }) {
 ...
 <span className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full admin-logo-sq text-white text-[8px] font-bold flex items-center justify-center">3</span>
 </button>

 <div className="w-9 h-9 rounded-xl admin-logo-sq flex items-center justify-center text-white text-xs font-bold flex-shrink-0 shadow-sm ">
 A
 </div>
 </header>
 );
