      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-10 border border-[#E4E8F0]">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold text-white bg-[#003580] hover:bg-[#00276B] active:bg-[#001F52] disabled:opacity-50 disabled:cursor-not-allowed transition shadow-sm hover:shadow-md"
          >
            {loading ? (
              <>
