...
export function DashboardClient({ total, counts, recentQuestions }: Props) {
 ...
 <div className="w-12 h-12 rounded-2xl admin-icon-wrap flex items-center justify-center text-[#003580] group-hover:scale-105 transition-transform duration-200">
 ...
 const Icon = cfg.icon;
 return (
 <Link key={slug} href={`/admin/${slug}/new`} className="flex flex-col items-center gap-2 p-4 rounded-xl border border-[#E4E8F0] hover:border-[#003580] hover:admin-icon-wrap transition-all duration-150 group">
