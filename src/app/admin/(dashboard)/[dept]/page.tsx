...
export default async function DeptQuestionsPage({ params, searchParams }: Props) {
 ...
 <div className="flex-1 max-w-md flex items-center gap-2 px-3.5 py-2.5 bg-white border border-[#E4E8F0] rounded-xl text-sm focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/10 transition">
